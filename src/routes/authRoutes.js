...
authRoutes.post("/logout", sensitiveAuthRateLimit, auditAction("auth.logout"), asyncHandler(authController.logout));
authRoutes.post("/refresh", sensitiveAuthRateLimit, asyncHandler(authController.refresh));
